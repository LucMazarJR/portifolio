        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <a href="#experiencia" className="text-muted-foreground hover:text-primary transition-colors">
                Experiência
              </a>
            ...
            <div className="flex gap-3 pt-2">
              {contactInfo.socials.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-card border border-border flex items-center justify-center hover:border-primary hover:bg-primary hover:text-white transition-all"
